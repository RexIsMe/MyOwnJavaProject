package com.atguigu.teacher.qz.service

import com.atguigu.teacher.qz.dao.{QzChapterDao, QzCourseDao, QzMajorDao, QzPaperDao, QzQuestionDao, UserPaperDetailDao}
...
object DwsQzService {
  ...
  def saveDwsQzChapter(sparkSession: SparkSession, dt: String) = {
    ...
    /*//相较于下面的join方式不会去除重名字段
    dwdQzChapter.join(dwdQzChapterlist, dwdQzChapter("chapterlistid")===dwdQzChapterlist("chapterlistid"))*/
