...
//    value.saveAsSequenceFile("hdfs://warehouse102:9000/seqFiles")

    val value: RDD[(String, Int)] = sc.sequenceFile[String, Int]("hdfs://warehouse102:9000/seqFiles")
