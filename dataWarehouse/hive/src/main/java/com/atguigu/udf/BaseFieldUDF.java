...
public class BaseFieldUDF extends UDF {
    ...
    public String evaluate(String line, String jsonkeysString){
        ...
        try {
            ...
            if("tt".equalsIgnoreCase(jsonkeys[0])){
                sb.append(logContents[0]).append("\t");
            } else if ("app".equalsIgnoreCase(jsonkeys[0])) {
                sb.append(jsonObject.getString("app")).append("\t");
            } else if ("et".equalsIgnoreCase(jsonkeys[0])){
